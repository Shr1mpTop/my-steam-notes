...
const messages: Record<Locale, Messages> = {
  zh: {
    ...
    playtime: "游玩",
    whenYouPlay: "游玩时间分布",
    timeHeatmapSubtitle: "按状态持续时间积分：游戏中权重更高，Steam 在线权重较低",
    weightedActivity: "加权活跃",
    inGame: "游戏中",
    steamOnline: "Steam 在线",
    gameBreakdown: "游戏明细",
    noGameDetail: "无具体游戏记录",
    gamingClock: "游戏时钟",
    gamingClockSubtitle: "历史平均 vs 最近 24 小时",
  ...
  en: {
    ...
    timeHeatmapSubtitle: "Integrated by status duration: in-game weighs more than Steam online",
    weightedActivity: "weighted activity",
    inGame: "in game",
    steamOnline: "Steam online",
    gameBreakdown: "Game breakdown",
    noGameDetail: "No game detail",
    gamingClock: "Gaming Clock",
    gamingClockSubtitle: "Historical average vs last 24 hours",
